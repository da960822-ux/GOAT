...
| `excludeIds` | string[] | | 다시 추천 시 제외할 place_id 배열. 최대 61개 |
...
{ "user_id": "<uuid>", "place_id": "GOAT-024" }
```

### 북마크 삭제
```http
DELETE /rest/v1/bookmarks?user_id=eq.<uuid>&place_id=eq.GOAT-024
Authorization: Bearer <jwt>
```

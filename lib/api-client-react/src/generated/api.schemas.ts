...
export type PublicSelectionsSuccessResponse = ApiSuccessBase & {
  data: PublicSelectionsSuccessResponseData;
};
...
export type PlacePhotosSuccessResponse = ApiSuccessBase & {
  data: PlacePhotosData;
};
...
export type GetSceneCoverParams = {
/**
 * @minLength 1
 */
selectionId: string;

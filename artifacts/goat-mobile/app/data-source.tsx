    ...
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <InfoBlock
          ...
          colors={colors}
          items={[
            '카카오맵, 네이버 지도, 티맵 링크는 장소명+도시 검색 방식으로 연결됩니다.',
            '좌표(lat/lng) 데이터는 현재 버전에 포함되어 있지 않습니다.',
            '검색 결과는 각 지도 앱의 알고리즘에 따라 다를 수 있습니다.',
          ]}
        />
        <InfoBlock
          title="데이터 업데이트"

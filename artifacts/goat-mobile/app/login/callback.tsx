...
export default function LoginCallbackScreen() {
  ...
  return <View style={styles.screen}><Image source={require("@/assets/images/goat-symbol-cutout.png")} contentFit="contain" style={styles.logo} accessibilityLabel="강원도 모양 GOAT 로고"/><ActivityIndicator color={palette.forest}/><Text style={styles.text}>로그인을 확인하고 있어요.</Text></View>;
}

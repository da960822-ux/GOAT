...
function replacementCopy(card: DisplayCard) {
  if (!card.canReplace || card.replacementCount === 0) return "현재 조건에서 바꿀 수 있는 다른 후보가 없어요";
  return `교체 가능 · 후보 ${card.replacementCount}곳`;
}

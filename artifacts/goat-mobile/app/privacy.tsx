...
const SECTIONS = [
  ...
  {
    title: '이용자의 선택과 권리',
    body: '로그인은 선택 사항이며 동의하지 않아도 장면 추천과 기기 저장을 이용할 수 있습니다. 개인정보 열람·정정·삭제 또는 계정 삭제는 da960822@gmail.com으로 요청할 수 있습니다. 요청자의 계정을 확인한 뒤 처리 결과를 안내합니다.',
  },
  {
    title: '문의',
    body: '개인정보 처리방침, 개인정보 열람·정정·삭제 및 계정 삭제 요청은 da960822@gmail.com으로 연락해 주세요. 출시 전에 원스토어 판매자 정보와 동일한 운영자명·전화번호·웹사이트를 공개 정책 페이지에 게시합니다.',
  },
];

...
- 디자인 기준·공용 시스템·핵심 흐름·상태 화면·자산·QA를 분리해 작업한다.
- 구현자는 화면별 시안 계약과 공용 컴포넌트만 사용하며, API 계약 변경은 별도 승인 없이는 수행하지 않는다.
- 모든 병합은 타입 검사, 결정적 데이터 fixture, 390×844 및 430×932 캡처, 접근성 확인을 통과해야 한다.
